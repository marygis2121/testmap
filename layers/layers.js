...
var lyr_C10_1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'Cумма температур в почвах > 10 градусов<br> <img src="legend.png" wight="100px">',
...
lyr_T_2.set('fieldAliases', {'name': 'название района', 'Co': 'Co, м/кг', 'Cu': 'Cu, м/кг', 'Zn': 'Zn, м/кг', });
